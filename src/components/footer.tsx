...
const Footer = () => {
  const socialLinks = [
    {
      href: "https://github.com/FaiqCh-456",
    ...
    {
      href: "https://www.linkedin.com/in/faiq-ch",
      icon: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-8 h-8">
    ...
    {
      href: "https://mail.google.com/mail/?view=cm&fs=1&to=faiqyousaf25@gmail.com&su=Hey%20Faiq!",
  ...
  return (
    <footer className="w-full py-12 bg-gray-900 border-t border-gray-800 mt-9">
